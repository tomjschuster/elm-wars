...
var _user$project$Main$translateFields = F3(
	function (personInLanguage, planetInLanguage, person) {
		return _elm_lang$core$Native_Utils.update(
			person,
			{name: personInLanguage.name, gender: personInLanguage.gender, planet: planetInLanguage});
	});
...
var _user$project$Main$emptyQueryResult = function (queryString) {
	return {
		people: {ctor: '[]'},
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {query: a, queryResult: b, person: c, language: d};
	});
var _user$project$Main$QueryResult = F5(
	function (a, b, c, d, e) {
		return {people: a, queryString: b, count: c, next: d, previous: e};
	});
...
var _user$project$Main$init = {
	...
	_0: A4(
		...
		'',
		_user$project$Main$emptyQueryResult(''),
		_elm_lang$core$Maybe$Nothing,
	...
	if (_p6.ctor === 'English') {
		return A4(
			...
			_elm_lang$core$Json_Decode$maybe(
				_user$project$Main$planetDecoder(_user$project$Main$English)),
			_elm_lang$core$Maybe$Nothing,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'homeworld',
		...
		return A4(
			...
			'planet',
			_elm_lang$core$Json_Decode$maybe(
				_user$project$Main$planetDecoder(_user$project$Main$Wookiee)),
			_elm_lang$core$Maybe$Nothing,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'acooscwoohoorcanwa',
				...
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$Translate(toLanguage)),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$Main$SelectResult = function (a) {
	return {ctor: 'SelectResult', _0: a};
};
	...
	return A2(
		_elm_lang$html$Html$button,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$SelectResult(person)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Main$resultsList = function (queryResult) {
	var description = _elm_lang$core$Native_Utils.eq(queryResult.queryString, '') ? '' : A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(queryResult.count),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' found for \"',
			A2(_elm_lang$core$Basics_ops['++'], queryResult.queryString, '\"')));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_1: A2(_elm_lang$core$List$map, _user$project$Main$resultsRow, queryResult.people)
			}
		});
};
...
var _user$project$Main$getQueryResults = function (url) {
	return A2(
		_elm_lang$core$Task$attempt,
...
var _user$project$Main$queryByName = function (name) {
	...
	return _user$project$Main$getQueryResults(url);
};
		...
		switch (_p10.ctor) {
			...
			case 'SelectResult':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Main$getPerson, model.language, _p10._0)
				};
			case 'GetPerson':
				if (_p10._0.ctor === 'Ok') {
					return {
			...
			default:
				var _p12 = _p10._0;
				var cmd = function () {
					var _p11 = model.person;
					if (_p11.ctor === 'Just') {
						return A2(_user$project$Main$getPerson, _p12, _p11._0);
					} else {
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$resultsList(model.queryResult),
							_1: {
								ctor: '::',
